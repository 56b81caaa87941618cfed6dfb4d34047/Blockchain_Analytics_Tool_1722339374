...
Vue.component("purple_feature_grid_component_1722339378", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our advanced blockchain monitoring system. Get instant alerts and analysis on new transactions, blocks, and smart contract events as they happen.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain invaluable insights into blockchain activity with our powerful data analysis tools. Identify trends, detect anomalies, and make informed decisions based on accurate, up-to-date information.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Tailor our alerting system to your specific needs. Set custom triggers for transactions, address activity, token transfers, and more. Never miss an important event.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform integrates seamlessly with your existing blockchain infrastructure and tools. Access rich data streams through our user-friendly API or intuitive dashboard.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">We prioritize the security and privacy of your data. Our system employs industry-leading encryption and authentication protocols to protect your valuable information.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform is designed to grow with your needs. Easily scale your monitoring and analysis capabilities as your blockchain footprint expands, future-proofing your operations.</p></div>
        </div>
    </div>`,
        data() {
            return {
