...
Vue.component("purple_hero_component_1722339378", {
    template: `
    <div class="flex">
        <aside class="w-64 h-screen bg-purple-800 text-white p-6">
            <nav>
                <ul class="space-y-4">
                    <li><a href="#" class="hover:text-purple-300 flex items-center"><i class='bx bx-home mr-2'></i>Home</a></li>
                    <li><a href="#" class="hover:text-purple-300 flex items-center"><i class='bx bx-info-circle mr-2'></i>About</a></li>
                    <li><a href="#" class="hover:text-purple-300 flex items-center"><i class='bx bx-envelope mr-2'></i>Contact</a></li>
                </ul>
            </nav>
        </aside>
        <section id="hero-section-container" class="flex-1">
